...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="{{asset('imgadmin/svg/logo.svg')}}" type="image/x-icon">
  <!-- Custom styles -->
...
<!-- Chart library -->
<script src="{{asset('pluginsadmin/chart.min.js')}}"></script>
<!-- Icons library -->
<script src="{{asset('pluginsadmin/feather.min.js')}}"></script>
<!-- Custom scripts -->
<script src="{{asset('jsadmin/script.js')}}"></script>
</body>
